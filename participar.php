                ...
                <div id="personaNatural" name="nat">
                    <form class="form_ingreso"action="actions/add_miembro.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" placeholder="Dirección" aria-label="Dirección" name="direccion" required>
                                 <!-- pattern="[A-Za-z0-9]{5,200} class_alia title="Letras y números. Tamaño mínimo: 4. Tamaño máximo: 200" -->
                            </div>  
                        </div> <br>
                        <div class="row">
                            <div class="col-md-12">
                    ...
                    <form class="form_ingreso"action="actions/add_miembro.php" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-12 forminput">
                                <input type="text" class="form-control forminput " placeholder="Nombre" aria-label="Nombre" name="nombres" required>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row">          
                            <div class="col-md-3">
                                <input type="text" class="form-control" placeholder="Rif" aria-label="Rif" name="dni" required>
                            </div>
                            <div class="col-md-3">
                                <input style="display:none" type="datetime" class="form-control" placeholder="Fecha de nacimiento" aria-label="Fecha de Nacimiento" name="fechaNac" value="20/07/2021" required>
                            </div>
                            <div class="col-md-3" style="display:none">
                                ...
                                <select class="form-select form-control" id="autoSizingSelect" name="pais">
                                    <option selected="">País</option>
                                    <option value="Argentina">Argentina</option>
                                    <option value="Brasil">Brasil</option>
                                    <option value="Colombia">Colombia</option>
                            ...
                            <select class="form-select form-control" id="area" name="area">
                                <option selected="">área</option>
                                    <?php while ($consulA2 = mysqli_fetch_assoc($consulAreas2)) {
                                        // En esta sección estamos llenando el select con datos extraidos de una base de datos.
                                        echo '<option value="'.$consulA2['id_area'].'">'.$consulA2['nombre'].'</option>';
                                    }?>
                                </select>
                            </div>
                            </div>
